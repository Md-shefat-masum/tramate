            ...
            <div class="card-header bg-info">
              <div class="row">
                <div class="col-md-8 header_text">
                    <i class="fa fa-bandcamp" ></i> All Buses
                </div>
                <div class="col-md-4 header_button">
                <a href="{{url('admin/service-package/add')}}" class="btn btn-sm btn-warning"><i class="fa fa-plus-circle" ></i>  Add Buses</a>
                </div>
              </div>
            </div>
            <div class="card-body">
                ...
                <table class="table table-striped all_view_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="{{asset('uploads/services/'.$data->service->service_photo)}}" width="100" alt="bus photo"></td>
                                <td>{{$data->time}}</td>
                                <td>{{$data->price}}</td>
