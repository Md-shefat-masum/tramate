        ...
        <div class="card">
            <div class="card-header bg-info">
              <div class="row">
                ...
                <a href="{{url('admin/service-package/add')}}" class="btn btn-sm btn-warning"><i class="fa fa-plus-circle" ></i>  Add Hotels</a>
                </div>
              </div>
            </div>
            <div class="card-body">
                ...
                <table class="table table-striped all_view_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="{{asset('uploads/services/'.$data->service->service_photo)}}" width="100" alt="hotel photo"></td>
                                <td>{{str_limit($data->address, 10)}}</td>
                                <td>{{$data->contact}}</td>
                                <td>{{$data->price}}</td>
