...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <!-- ============================================================== -->
        <div class="card">
        <form method="post" action="{{url('admin/resturant/edit/update/'.$resturant->resturant_slug)}}" enctype="multipart/form-data">
            @csrf
                <div class="card-header bg-info">
                    <div class="row">
                        <div class="col-md-8 header_text">
                            <i class="fa fa-bandcamp"></i> Edit Restaurant Information
                        </div>
                        <div class="col-md-4 header_button">
                                <a href="{{url('admin/resturant')}}" class="btn btn-sm btn-warning"><i class="fa fa-th"></i> All Restaurants</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    @if(Session::has('success_resturant_edit'))
                    <script>
                        swal({
                            title: "Success!",
                    ...
                    @if(Session::has('error_resturant_edit'))
                    <script>
                        swal({
                            title: "Opps!",
                    ...
                    <div class="form-body cus_fbody">
                        <div class="form-group row{{$errors->has('from')? ' has-error':''}}">
                            ...
                            <div class="col-sm-8">
                                <select name="from" class="form-control">
                                    ...
                                    <option value="{{$froms->from_id}}" {{Request::is($resturant->from_id==$froms->from_id)? 'selected':''}}>{{$froms->from_name}}</option>
                        ...
                        <div class="form-group row{{$errors->has('name')? ' has-error':''}}">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="name" value="{{$resturant->resturant_name}}">
                                    @if ($errors->has('name'))
                                    <span class="invalid-feedback mb-0" role="alert">
                        ...
                        <div class="form-group row{{$errors->has('details')? ' has-error':''}}">
                                ...
                                <div class="col-sm-8">
                                    <textarea name="details" id="" class="form-control"
                                        value="">{{$resturant->resturant_details}}</textarea>
                        ...
                        <div class="form-group row{{$errors->has('cate')? ' has-error':''}}">
                            ...
                            <div class="col-sm-8">
                                <select name="cate" class="form-control">
                                    ...
                                    <option value="{{$cates->cate_id}}" {{Request::is($resturant->cate_id==$cates->cate_id)? 'selected':''}}>{{$cates->cate_name}}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('cate'))
                                <span class="invalid-feedback mb-0" role="alert">
                        ...
                        <div class="form-group row{{$errors->has('lowest')? ' has-error':''}}">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="lowest" value="{{$resturant->resturant_lowest_rate}}">
                        ...
                        <div class="form-group row{{$errors->has('highest')? ' has-error':''}}">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="highest" value="{{$resturant->resturant_highest_rate}}">
                        ...
                        <div class="form-group row{{$errors->has('address')? ' has-error':''}}">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="address" value="{{$resturant->resturant_address}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <img src="{{asset('uploads/resturants/'.$resturant->resturant_photo)}}" width="100" alt="resturant photo">
                                @if ($errors->has('photo'))
                                <span class="invalid-feedback mb-0" role="alert">
