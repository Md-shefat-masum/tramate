...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <!-- ============================================================== -->
        <div class="card">
            <form method="post" action="{{url('admin/plan/add/upload')}}" enctype="multipart/form-data">
                @csrf
                <div class="card-header bg-info">
                    <div class="row">
                        <div class="col-md-8 header_text">
                            <i class="fa fa-bandcamp"></i> Add Plan Information
                        </div>
                        <div class="col-md-4 header_button">
                            <a href="{{url('admin/plan')}}" class="btn btn-sm btn-warning"><i class="fa fa-th"></i>
                                All Plans</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    @if(Session::has('success_plan_upload'))
                    <script>
                        swal({
                            title: "Success!",
                    ...
                    @if(Session::has('error_plan_upload'))
                    <script>
                        swal({
                            title: "Opps!",
                    ...
                    <div class="form-body cus_fbody">
                        ...
                        <div class="form-group row{{$errors->has('li1')? ' has-error':''}}">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="li1" value="{{old('li1')}}">
                                @if ($errors->has('li1'))
                                <span class="invalid-feedback mb-0" role="alert">
                        ...
                        <div class="form-group row{{$errors->has('li2')? ' has-error':''}}">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="li2" value="{{old('li2')}}">
                                @if ($errors->has('li2'))
                                <span class="invalid-feedback mb-0" role="alert">
                        ...
                        <div class="form-group row{{$errors->has('li3')? ' has-error':''}}">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="li3" value="{{old('li3')}}">
                                @if ($errors->has('li3'))
                                <span class="invalid-feedback mb-0" role="alert">
                        ...
                        <div class="form-group row{{$errors->has('li4')? ' has-error':''}}">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="li4" value="{{old('li4')}}">
                                @if ($errors->has('li4'))
                                <span class="invalid-feedback mb-0" role="alert">
                        ...
                        <div class="form-group row{{$errors->has('li5')? ' has-error':''}}">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="li5" value="{{old('li5')}}">
                                @if ($errors->has('li5'))
                                <span class="invalid-feedback mb-0" role="alert">
