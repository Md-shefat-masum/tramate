...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <!-- ============================================================== -->
        <div class="card">
            <form method="post" action="{{url('admin/user/edit/update/'.$user->slug)}}" enctype="multipart/form-data">
                @csrf
                <div class="card-header bg-info">
                    <div class="row">
                        <div class="col-md-8 header_text">
                            <i class="fa fa-bandcamp"></i> Edit User Information
                        </div>
                ...
                <div class="card-body">
                    @if(Session::has('success_user_edit'))
                    <script>
                        swal({
                            title: "Success!",
                    ...
                    @if(Session::has('error_user_edit'))
                    <script>
                        swal({
                            title: "Opps!",
                    ...
                    <div class="form-body cus_fbody">
                        ...
                        <div class="form-group row{{$errors->has('role')? ' has-error':''}}">
                            ...
                            <div class="col-sm-8">
                                <select name="role" class="form-control">
                                    ...
                                    <option value="{{$data->role_id}}" {{Request::is($data->role_id==$user->role_id)? 'selected':''}}>{{$data->role_name}}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="file" name="photo" value="{{asset('uploads/users/'.$user->photo)}}">
                                <img src="{{asset('uploads/users/'.$user->photo)}}" width="100" alt="user photo">
                                @if ($errors->has('photo'))
                                <span class="invalid-feedback mb-0" role="alert">
