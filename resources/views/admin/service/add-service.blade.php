...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <!-- ============================================================== -->
        <div class="card">
            <form method="post" action="{{url('admin/service/add/upload')}}" enctype="multipart/form-data">
                @csrf
                <div class="card-header bg-info">
                    <div class="row">
                        <div class="col-md-8 header_text">
                            <i class="fa fa-bandcamp"></i> Add Service Information
                        </div>
                ...
                <div class="card-body">
                    @if(Session::has('success_service_upload'))
                    <script>
                        swal({
                            title: "Success!",
                    ...
                    @if(Session::has('error_service_upload'))
                    <script>
                        swal({
                            title: "Opps!",
                    ...
                    <div class="form-body cus_fbody">
                        <div class="form-group row{{$errors->has('name')? ' has-error':''}}">
                            <label for="" class="col-sm-3 col-form-label cus_flabel">Sercive Name:</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row{{$errors->has('type')? ' has-error':''}}">
                            ...
                            <div class="col-sm-8">
                                <select name="type" class="form-control">
                                    ...
                                    <option value="{{$data->service_type_id}}">{{$data->service_type_name}}</option>
