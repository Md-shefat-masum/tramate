...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <!-- ============================================================== -->
        <div class="card">
            <form method="post" action="{{url('admin/blog/edit/update/'.$blog->blog_slug)}}"
                enctype="multipart/form-data">
                @csrf
                <div class="card-header bg-info">
                    <div class="row">
                        <div class="col-md-8 header_text">
                            <i class="fa fa-bandcamp"></i> Edit Blog Information
                        </div>
                ...
                <div class="card-body">
                    @if(Session::has('success_blog_edit'))
                    <script>
                        swal({
                            title: "Success!",
                    ...
                    @if(Session::has('error_blog_edit'))
                    <script>
                        swal({
                            title: "Opps!",
                    ...
                    <div class="form-body cus_fbody">
                            <div class="form-group row{{$errors->has('title')? ' has-error':''}}">
                                ...
                                <div class="form-group row{{$errors->has('details')? ' has-error':''}}">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        value="">{{$blog->blog_details}}</textarea>
                                ...
                                <div class="form-group row{{$errors->has('cate')? ' has-error':''}}">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="cate" class="form-control">
                                            ...
                                            <option value="{{$data->cate_id}}" {{Request::is($data->cate_id==$blog->blog_cate_id)? 'selected':''}}>{{$data->cate_name}}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <img src="{{asset('uploads/blogs/'.$blog->blog_photo)}}" width="100"
                                    alt="blog photo">
                                @if ($errors->has('photo'))
                                <span class="invalid-feedback mb-0" role="alert">
