...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <!-- ============================================================== -->
        <div class="card">
            <form method="post" action="{{url('admin/visitable/add/upload')}}" enctype="multipart/form-data">
                @csrf
                <div class="card-header bg-info">
                    <div class="row">
                        <div class="col-md-8 header_text">
                            <i class="fa fa-bandcamp"></i> Add Visitable Place Information
                        </div>
                        <div class="col-md-4 header_button">
                            <a href="{{url('admin/visitable')}}" class="btn btn-sm btn-warning"><i class="fa fa-th"></i>
                                All Visitable Places</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    @if(Session::has('success_visitable_upload'))
                    <script>
                        swal({
                            title: "Success!",
                    ...
                    @if(Session::has('error_visitable_upload'))
                    <script>
                        swal({
                            title: "Opps!",
