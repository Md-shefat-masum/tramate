...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <!-- ============================================================== -->
        <div class="card">
            <form method="post" action="{{url('admin/gallery/edit/update/'.$gallery->gallery_slug)}}"
                enctype="multipart/form-data">
                @csrf
                <div class="card-header bg-info">
                    <div class="row">
                        <div class="col-md-8 header_text">
                            <i class="fa fa-bandcamp"></i> Edit Gallery Information
                        </div>
                        <div class="col-md-4 header_button">
                            <a href="{{url('admin/gallery')}}" class="btn btn-sm btn-warning"><i
                                    class="fa fa-th"></i>
                                All Galleries</a>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    @if(Session::has('success_gallery_edit'))
                    <script>
                        swal({
                            title: "Success!",
                    ...
                    @if(Session::has('error_gallery_edit'))
                    <script>
                        swal({
                            title: "Opps!",
                    ...
                    <div class="form-body cus_fbody">
                        <div class="form-group row{{$errors->has('views')? ' has-error':''}}">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="views" value="{{$gallery->gallery_views}}">
                                @if ($errors->has('views'))
                        ...
                        <div class="form-group row{{$errors->has('comments')? ' has-error':''}}">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="comments" value="{{$gallery->gallery_comments}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <img src="{{asset('uploads/gallerys/'.$gallery->gallery_photo)}}" width="100"
                                    alt="gallery photo">
                                @if ($errors->has('photo'))
                                <span class="invalid-feedback mb-0" role="alert">
