...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <!-- ============================================================== -->
        <div class="card">
            <form method="post" action="{{url('admin/desti-slider/edit/update/'.$slider->slider_slug)}}"
                enctype="multipart/form-data">
                @csrf
                <div class="card-header bg-info">
                    <div class="row">
                        <div class="col-md-8 header_text">
                            <i class="fa fa-bandcamp"></i> Edit Destination Slider Information
                        </div>
                ...
                <div class="card-body">
                    @if(Session::has('success_slider_edit'))
                    <script>
                        swal({
                            title: "Success!",
                    ...
                    @if(Session::has('error_slider_edit'))
                    <script>
                        swal({
                            title: "Opps!",
                    ...
                    <div class="form-body cus_fbody">
                        <div class="form-group row{{$errors->has('title')? ' has-error':''}}">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="title" value="{{$slider->slider_title}}">
                                @if ($errors->has('title'))
                        ...
                        <div class="form-group row{{$errors->has('details')? ' has-error':''}}">
                            ...
                            <div class="col-sm-8">
                                <textarea name="details" id="" class="form-control"
                                    value="">{{$slider->slider_details}}</textarea>
                        ...
                        <div class="form-group row{{$errors->has('category')? ' has-error':''}}">
                            ...
                            <div class="col-sm-8">
                                <select name="category" class="form-control">
                                    ...
                                    <option value="{{$data->descate_id}}" {{Request::is($data->descate_id==$slider->slider_category)? 'selected':''}}>{{$data->descate_name}}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <img src="{{asset('uploads/desti-sliders/'.$slider->slider_photo)}}" width="100"
                                    alt="slider photo">
                                @if ($errors->has('photo'))
                                <span class="invalid-feedback mb-0" role="alert">
